        ...
        urlBase + "/Reviews/:id",
          { 'id': '@id' },
          {
            ...
            "::count::Reviewer::reviews": {
              url: urlBase + "/Y/:id/reviews/count",
              method: "GET",
            },
          }
        );
